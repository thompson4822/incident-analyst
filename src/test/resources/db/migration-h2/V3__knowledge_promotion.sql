...
ALTER TABLE diagnoses ADD COLUMN IF NOT EXISTS verified_at TIMESTAMP;
ALTER TABLE diagnoses ADD COLUMN IF NOT EXISTS verified_by VARCHAR(255);

-- Add source_type and diagnosis_id to incident_embeddings table
ALTER TABLE incident_embeddings ADD COLUMN IF NOT EXISTS source_type VARCHAR(50) NOT NULL DEFAULT 'RAW_INCIDENT';
